...
//	private static final String TAG = HelpScreen.class.getName();
	...
	final String helpText = "" +
			"Tap a square to clear it, clear a line in any direction to win!\n" +
			"\n" +
...
//			Gdx.app.log(TAG, "Back!");
		...
		game.font32.drawWrapped(game.batch, helpText, helpRect.x, helpRect.y + helpRect.height, helpRect.width, HAlignment.CENTER);
