...
//	private static final String TAG = MenuScreen.class.getName();
	...
	private static final String[] SUBJECTS = new String[] {"UK Town", "Nature", "UK Road Signs", "US Road Signs", "Fruit and Veg", "Letters", "Shapes"};
...
//			Gdx.app.log(TAG, "Back!");
		...
		game.font64.drawMultiLine(game.batch, titleText, titleRect.x, titleRect.y + titleRect.height, titleRect.width, HAlignment.CENTER);
		game.font48.setColor(enabled);
		game.font48.draw(game.batch, newGameText, newGameRect.x, newGameRect.y + newGameRect.height);
		game.font48.draw(game.batch, subjectText + SUBJECTS[subject], subjectRect.x, subjectRect.y + subjectRect.height);
