...
//	private static final String TAG = CreditsScreen.class.getName();
	...
	final String creditsText = "" +
			...
			"Built using libGDX.\n" +
			"\n" +
			"UK Road Signs used under licence from UK Govt, " +
			"US Road Signs public domain via US DOT, " +
	...
	protected void doResize(int displayWidth, int displayHeight) {
		...
		backRect.setPosition(gameArea.gameRect.x + gameArea.gameRect.width / 2 - backRect.width / 2, gameArea.gameRect.y + screenPadding);
...
//			Gdx.app.log(TAG, "Back!");
		...
		game.font38.drawWrapped(game.batch, creditsText, creditsRect.x, creditsRect.y + creditsRect.height, creditsRect.width, HAlignment.CENTER);
